...
public class ClientsControllerTest {
	...
	public void ab_changeClient() throws UnsupportedEncodingException, Exception {
		...
		String newName = "Client Test Altered";
	...
	@Test
	public void acb_getAllClientsWithFuzzy() throws UnsupportedEncodingException, Exception {

		final MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get("/Clients?keyword=Client Tst")
				.characterEncoding(StandardCharsets.UTF_8.name()).contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
